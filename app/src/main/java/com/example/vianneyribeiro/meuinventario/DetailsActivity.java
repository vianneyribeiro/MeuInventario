...
public class DetailsActivity extends AppCompatActivity{
    ...
    private void addValuesToEditItem(long itemId) {
        ...
        cursor.moveToFirst();
        nameEdit.setText(cursor.getString(cursor.getColumnIndex(EstoqueContract.EstoqueEntry.COLUMN_NAME)));
        priceEdit.setText(cursor.getString(cursor.getColumnIndex(EstoqueContract.EstoqueEntry.COLUMN_PRICE)));
        quantityEdit.setText(cursor.getString(cursor.getColumnIndex(EstoqueContract.EstoqueEntry.COLUMN_QUANTITY)));
        supplierNameEdit.setText(cursor.getString(cursor.getColumnIndex(EstoqueContract.EstoqueEntry.COLUMN_SUPPLIER_NAME)));
        supplierPhoneEdit.setText(cursor.getString(cursor.getColumnIndex(EstoqueContract.EstoqueEntry.COLUMN_SUPPLIER_PHONE)));
        supplierEmailEdit.setText(cursor.getString(cursor.getColumnIndex(EstoqueContract.EstoqueEntry.COLUMN_SUPPLIER_EMAIL)));
        imageView.setImageURI(Uri.parse(cursor.getString(cursor.getColumnIndex(EstoqueContract.EstoqueEntry.COLUMN_IMAGE))));
    ...
    private int deleteAllRowsFromTable() {
        ...
        return database.delete(EstoqueContract.EstoqueEntry.TABLE_NAME, null, null);
    }
    ...
    private int deleteOneItemFromTable(long itemId) {
        ...
        int rowsDeleted = database.delete(
                EstoqueContract.EstoqueEntry.TABLE_NAME, selection, selectionArgs);
        return rowsDeleted;
    }
